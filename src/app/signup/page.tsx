...
import { Loader2, Eye, EyeOff, CheckCircle, XCircle, Sun, Moon, User } from 'lucide-react';
          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                disabled={isLoading || !name || !email || !password || !confirmPassword || !passwordValidation.isValid || !passwordsMatch}
              >
